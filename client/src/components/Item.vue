  ...
  <div class="row">
    ...
    <div class="col">
      <b-button-group vertical>
        <b-button @click="plus(Item.product_id._id)" variant="outline-dark">
          Add +
        </b-button>
        <b-button @click="minus(Item.product_id._id)" variant="outline-dark">
          Remove -
        </b-button> </b-button-group
      ><br />
      <b-button @click="deleteOne(Item.product_id._id)" variant="outline-dark">
        Remove From Cart
      </b-button>
    </div>
  </div>
