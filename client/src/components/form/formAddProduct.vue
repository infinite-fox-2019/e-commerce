<template>
    <div>
        ...
        <form enctype="multipart/form-data" @submit.prevent="addProduct">
            ...
            <b-field horizontal label="Categori" type="is-primary" message="Please enter category with space">
                <b-input v-model="category" name="categori" placeholder="Categori" expanded></b-input>
            </b-field>
