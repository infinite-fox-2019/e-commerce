    ...
    <div>
        <nav-bar-store>
            ...
            <template v-slot:createProduct>
                <button class="btn btn-primary" @click.prevent="showCreate ">
                    Create Product
                </button>
            </template>
            <template v-slot:product>
              <router-link to="/product" style="color:white;"><button  @click="showProduct"  class="btn btn-primary">Product</button></router-link>
            </template>
            <template v-slot:allProduct>
              <router-link to="/product/allProduct" style="color:white;"><button class="btn btn-primary" id="btn-left">All Product</button></router-link>
            </template>
        </nav-bar-store>
