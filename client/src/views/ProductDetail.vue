        ...
        <div class="flex-column justify-around text-left p-4 m-6 border border-gray-300">
            ...
            <div class="flex justify-end m-2 p-2">
                <div class="inline-block relative w-64 mx-4">
                  <select v-if="role==='user'" class=" p-2 block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" v-model="qty">
                ...
                <button v-if="role==='user'" class="cursor-pointer border shadow bg-black hover:bg-gray-800 text-white hover:text-grey-900 p-2" @click.prevent="addToCart">Add to Cart</button>
            </div>
        </div>
    </div>
</template>
